...
<main class="container h-auto md:py-150 py-50">
	<section class="relative flex justify-center md:mb-150 mb-250">
		<div class="flex flex-col absolute md:top-350 md:left-320 top-300 left--6">
			<h2 class="font-medium md:text-50 text-35 text-white"> <?= $titulo ?></h2>
			<div class="text-16 text-white"><?= $texto ?></div>
			<a class="border border-white bg-transparent pt-20 pb-16 md:px-40 mx-20 text-center h-auto md:w-250 w-180 text-18 font-medium my-20 hover:font-600 hover:text-19" href="<?= $link ?>"><?= $boton ?></a>
		</div>
