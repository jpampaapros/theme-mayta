...
<main class="container h-auto py-150">
	<section class="relative flex justify-center mb-150">
		<div class="flex flex-col absolute top-350 left-320">
			...
			<a class="border border-white bg-transparent py-20 px-40 text-center h-auto w-250 text-18 font-medium my-20" href="<?= $link ?>"><?= $boton ?></a>
		</div>
...
<?= $carta ?>
<a class="py-20 px-40 text-18 bg-transparent border border-white my-20" href="<?= $link_carta ?>"><?= $boton_carta ?></a>
